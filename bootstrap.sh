...
# mv cocos2d-js-Cocos2d-JS-v3.3-final/ cocosjs

# cd cocosjs

# git submodule update --init --recursive
git clone --recursive https://github.com/cocos2d/cocos2d-js
...
# sudo cmake ../.. -DCMAKE_C_COMPILER=/usr/bin/gcc-4.9 -DCMAKE_CXX_COMPILER=/usr/bin/g++-4.9
